...
def main():
    ...
    create_table(cursor,countries_table,regions_urls_table)
    with ThreadPoolExecutor(max_workers=15) as executor:
      future = executor.submit( regions_urls,countries_table,"Country","Url", "Region" )
    ...
    # with ThreadPoolExecutor(max_workers=15) as executor:
    #     future = executor.submit( regions_urls,regions_urls_table,"Country","Url", "Region" )
    ...
    #     future = executor.submit( regions_urls,sub_regions_table,"Country","Url", "Region" )
    #     sub_reg_urls = future.result()
